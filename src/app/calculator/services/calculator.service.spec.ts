...
describe('CalculatorService', () => {
  ...
  it('should handle operator correctly for addition', () => {
    service.constructNumber('1');
    service.constructNumber('+');
    service.constructNumber('2');
    service.constructNumber('=');
  ...
  it('should handle operator correctly for substraction', () => {
  ...
  it('should handle operator correctly for multiply', () => {
    service.constructNumber('5');
    service.constructNumber('*');
    service.constructNumber('2');
    service.constructNumber('=');
  ...
  it('should handle operator correctly for division', () => {
    service.constructNumber('1');
