...
describe('CalculatorButtonComponent', () => {
  ...
  it('should aply w-1/4 if duoblesize is false', () => {
    const hostCssClasses: string[] = compiled.classList.value.split(' ');
    expect(hostCssClasses).toContain('w-1/4');
    expect(component.isDoubleSize()).toBeFalse();
  });

  it('should aply w-2/4 if duoblesize is true', () => {
  ...
  it('should set isPressed to true and then false when keyboardPressed is called with a matching key', (done) => {
